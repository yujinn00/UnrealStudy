...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UCard_Statics::NewProp_CardType = { "CardType", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UCard, CardType), Z_Construct_UEnum_UnrealDelegate_ECardType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CardType_MetaData), NewProp_CardType_MetaData) }; // 395086346
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Workspace_UnrealStudy_UEPart1_UnrealDelegate_Source_UnrealDelegate_Card_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ECardType_StaticEnum, TEXT("ECardType"), &Z_Registration_Info_UEnum_ECardType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 395086346U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCard, UCard::StaticClass, TEXT("UCard"), &Z_Registration_Info_UClass_UCard, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCard), 23241748U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Workspace_UnrealStudy_UEPart1_UnrealDelegate_Source_UnrealDelegate_Card_h_2353555593(TEXT("/Script/UnrealDelegate"),
	Z_CompiledInDeferFile_FID_Workspace_UnrealStudy_UEPart1_UnrealDelegate_Source_UnrealDelegate_Card_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Workspace_UnrealStudy_UEPart1_UnrealDelegate_Source_UnrealDelegate_Card_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Workspace_UnrealStudy_UEPart1_UnrealDelegate_Source_UnrealDelegate_Card_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Workspace_UnrealStudy_UEPart1_UnrealDelegate_Source_UnrealDelegate_Card_h_Statics::EnumInfo));
// End Registration
